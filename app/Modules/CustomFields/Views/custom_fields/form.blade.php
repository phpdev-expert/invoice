				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							@if ($editMode == true)
							{!! Form::text('table_name', $tableNames[$customField->table_name], ['id' => 'table_name', 'readonly' => 'readonly', 'class' => 'form-control']) !!}
							@else
							{!! Form::select('table_name', $tableNames, null, ['id' => 'table_name', 'class' => 'form-control']) !!}
							@endif
						</div>
