...
Route::group(['prefix' => 'client_center', 'namespace' => 'FI\Modules\ClientCenter\Controllers'], function ()
{
    ...
    Route::get('invoices/{invoiceKey}/pdf/content', ['uses' => 'ClientCenterPublicInvoiceController@getPdfContent', 'as' => 'clientCenter.public.invoice.pdf.content']);
    ...
    Route::get('quote/{quoteKey}/pdf/content', ['uses' => 'ClientCenterPublicQuoteController@getPdfContent', 'as' => 'clientCenter.public.quote.pdf.content']);
